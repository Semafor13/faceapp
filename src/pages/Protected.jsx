    ...
    <div className="bg-white pt-40 md:pt-60">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="text-center mb-24">
          ...
          />
          <h1
            className="block text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-blue-800"
            style={{
              lineHeight: "1.5",
            }}
          >
          ...
          <div
            ...
            className="flex gap-2 mt-12 w-fit mx-auto cursor-pointer z-10 py-3 px-6 rounded-full bg-gradient-to-r from-blue-400 to-blue-600"
          >
